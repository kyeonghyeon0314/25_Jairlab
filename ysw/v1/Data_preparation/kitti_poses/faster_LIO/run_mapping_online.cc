...
DEFINE_string(poses_log_file, (std::string(std::string(ROOT_DIR) + "Log/poses.txt")), "path to poses log file");
...
int main(int argc, char **argv) {
    ...
    LOG(INFO) << "save poses(R, T) to: " << FLAGS_poses_log_file;
    laser_mapping->SaveKITTIposes(FLAGS_poses_log_file);
